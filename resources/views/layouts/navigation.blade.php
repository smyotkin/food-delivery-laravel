        ...
        <div class="flex justify-between py-2">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                <x-dropdown align="right" width="48">
                    ...
                    <x-slot name="content">
                        <x-dropdown-link :href="route('profile.index')" class="text-center text-decoration-none">
                            {{ __('Профиль') }}
                        </x-dropdown-link>
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <x-dropdown-link :href="route('logout')" onclick="event.preventDefault(); this.closest('form').submit();" class="text-center text-decoration-none">
                                {{ __('Выйти из системы') }}
                            </x-dropdown-link>
                        </form>
                    </x-slot>
