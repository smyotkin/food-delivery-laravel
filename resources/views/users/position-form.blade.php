...
<div class="row">
    <form method="post" action="{{ isset($role) ? route('positions.update', ['position' => $role]) : route('positions.store') }}" id="position_form" class="col-12 col-md-10 update_position needs-validation" novalidate>
