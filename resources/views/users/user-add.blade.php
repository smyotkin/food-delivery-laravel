<x-app-layout>
    ...
    <div class="container-fluid px-5 mb-5">
        ...
        <div class="row">
            <div class="col-4">
                <form method="POST" action="{{ route('users/add') }}" id="user_form" class="row g-3 update_user">
                    @csrf

                    <div class="col-md-6">
                        <label for="first_name" class="form-label">Имя</label>
                        <input type="text" class="form-control rounded-0" id="first_name" name="first_name" value="">
                    </div>
                    <div class="col-md-6">
                        <label for="last_name" class="form-label">Фамилия</label>
                        <input type="text" class="form-control rounded-0" id="last_name" name="last_name" value="">
                    </div>
                    <div class="col-12">
                        <label for="phone" class="form-label">Мобильный телефон</label>
                        <input type="text" class="form-control rounded-0 ru-phone_format" id="phone" name="phone" placeholder="" value="" placeholder="+7 555 555-55-55">
                    </div>
                    <div class="col-12">
